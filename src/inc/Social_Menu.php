...
class Social_Menu implements Bootable, Displayable {
	...
	public function __construct() {
		$this->args = wp_parse_args( get_support( 'nanoweb_social_menu' ), [
			...
			'fallback'      => apply_filters( 'nanoweb/social_menu/fallback', [ $this, 'fallback' ] ),
		] );
		$this->args = apply_filters( 'nanoweb/social_menu/default_args', $this->args );

		$this->icons = apply_filters( 'nanoweb/social_menu/icons', $this->args['icons'] );
	...
	public function boot() {
		...
		add_action( 'nanoweb/social_menu', [ $this, 'display' ] );
	}
